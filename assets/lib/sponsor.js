...
ad.globalAd.call(function (err, result) {
	...
	$( "#current" ).html('<img src="' + clean(result[0]) + '" height="30" width="30"> ' + '<span class="text-dark">' + clean(result[1]) + '</span>' + ' <a target="_blank" href="' + clean(result[3]) + '" rel="nofollow" title="Links to an External Advertiser site" target="_blank"> <b>' + clean(result[2]) + '</b></a>');
});
